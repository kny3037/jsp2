...
<body>
		...
		<ul id="main">
			...
			<li id="content">
				<ul>
					<li>내용</li>		
					<!-- textarea에 입력한 엔터는  \n db에도 \n으로 저장됩니다.
						  브라우저 출력은 줄바꿈은 <br> 태그 해결1) pre태그, 해결2) \n을 <br>로 대체 -->		
					<li>
	...
	<!-- 메인글 출력 끝 -->
	<!-- 댓글 시작 -->
	<form action="commentAction.jsp?page=${page }" method="post" name="frmCmt">    <!-- POST 메소드는 주로 새로운 리소스를 생성(create)할 때 사용 -->
