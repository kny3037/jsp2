...
<body>
	...
	<ul>
		...
		<li>
			<ul>
				<li>request : HttpServletletRequest, 브라우저에 전달하는 요청정보를 저장</li>
		...
		<li>Attribute 를 저장하는 객체 : pageContext -> request -> session -> application
			(el 사용할 때 화살표 방향으로 저장된 애트리뷰트 값을 찾습니다.)
		</li>
		<li>※ el에서 사용할 수 있는 객체는 jsp 내장 객체와는 다릅니다.※</li>
	</ul>
<%
